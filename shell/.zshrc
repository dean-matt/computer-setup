...
ZSH_HIGHLIGHT_STYLES[builtin]='fg=26,bold'
ZSH_HIGHLIGHT_STYLES[command]='fg=26,bold'
ZSH_HIGHLIGHT_STYLES[precommand]='fg=26,bold'

# Cyan
ZSH_HIGHLIGHT_STYLES[path]='fg=14,underline'
ZSH_HIGHLIGHT_STYLES[path_pathseparator]='fg=195,underline,bold' #Brighter

# Purple
ZSH_HIGHLIGHT_STYLES[globbing]='fg=93,bold'
...
# Green
ZSH_HIGHLIGHT_STYLES[dollar-quoted-argument]='fg=41'

# Red
ZSH_HIGHLIGHT_STYLES[unknown-token]='fg=1,bold'
ZSH_HIGHLIGHT_STYLES[path_prefix]='fg=1,underline'
ZSH_HIGHLIGHT_STYLES[path_prefix_pathseparator]='fg=203,underline,bold' # Brighter
ZSH_HIGHLIGHT_STYLES[single-quoted-argument-unclosed]='fg=1,bold,standout'
